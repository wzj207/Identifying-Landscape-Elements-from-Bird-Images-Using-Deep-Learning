...
def train_model(model, criterion, optimizer, scheduler, num_epochs=50):
    history_save_path = os.path.join(history_folder, 'history-full-{}-{}-{}.txt'.format(run_num, model_name, SEED))
...
best_models_folder = 'Best_models/5_5/'
