...
def train_model(model, criterion, optimizer, scheduler, num_epochs=50):
    history_save_path = os.path.join(history_folder, 'history-three_fifth-{}-{}-{}.txt'.format(run_num, model_name, SEED))
...
best_models_folder = 'Best_models/{}/'.format(size)

history_folder = 'History/{}/'.format(size)
